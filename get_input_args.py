...
def get_input_args():
    ...
    parser.add_argument('--gpu', action = "store", default = 'cuda',  help = 'Chose between CPU or GPU (GPU recommended)')
    parser.add_argument('--epochs', type = int, default = 2, help='Choose the number of Epochs')
    parser.add_argument('--save_dir', type = str, default ='/home/workspace/ImageClassifier', help = 'Where to save the checkpoint file')
